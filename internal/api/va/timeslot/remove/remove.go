...
func (HTTPOperation) GetAsCurlCommand(withKey bool) (*http2curl.CurlCommand, error) {
	...
	req, rErr := api.NewDeleteTimeslotForVaccineAvailabilityByIdApiV1VaccineAvailabilityVaccineAvailabilityIdTimeslotsTimeslotIdDeleteRequest(utils.GetBaseURL(), vaID, tsID)
	if rErr != nil {
		return nil, rErr
	}
